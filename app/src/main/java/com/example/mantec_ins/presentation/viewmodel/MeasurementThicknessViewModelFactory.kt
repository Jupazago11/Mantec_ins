...
class MeasurementThicknessViewModelFactory(
    private val repository: MeasurementThicknessRepository
) : ViewModelProvider.Factory {

    @Suppress("UNCHECKED_CAST")
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(MeasurementThicknessViewModel::class.java)) {
            return MeasurementThicknessViewModel(repository) as T
        }
